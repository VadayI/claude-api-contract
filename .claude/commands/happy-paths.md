...
## Steps
1. Read `PROJECT.md` (§1–§3), `docs/project-state/endpoints.json`, and `openapi.yml` (if present) to determine which mode applies — story-level (registry empty/absent) or endpoint-annotated (registry populated).
