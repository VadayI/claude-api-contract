...
- [ ] **G (P2)** family-core plugin — Phase 0 done 2026-07-07 s14 (ADR 0011 **proposed**, awaiting review): next `claude-family-marketplace` repo -> `family-core v0.1.0` pilot here -> roll out to claude-django / claude-react-mui
